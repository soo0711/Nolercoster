...
<div>
   ...
   <form>
      ...
      <div class="d-flex justify-content-center mt-3">
         <input id="loginId" name="loginId" placeholder="아이디" class="form-control col-2">
      </div>
      ...
      <div class="d-flex justify-content-center mt-3">
         <input type="submit" value="비밀번호 찾기" class="btn bg-green col-2 border-0" id="findPwBtn">
      </div>
	...
	$(document).ready(function(){
		$("#findPwBtn").on('click' ,function(e){
			...
			$.ajax({
				type:"POST",
				url:"/user/find-pw",
				data: {"email":email, "loginId":loginId},
