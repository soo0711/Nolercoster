...
import com.Nolercoster.chatgpt.service.ChatGPTService;
...
public class ChatGPTRestController {
	...
	public void ChatGPTController(ChatGPTService chatGPTService) {
     ...
     */
    @PostMapping("/prompt")
    public ResponseEntity<Map<String, Object>> selectPrompt(@RequestBody CompletionRequestEntity completionRequestDto) {
